...
app.get("/searchmoviename", (req, res) => {
  ...
  var movieData = [];
  request(
    "https://www.omdbapi.com/?t=" + moviename + "&apikey=3389068b",
  ...
  request(
    {
      url:
        ...
        datee +
        '"' +
        "&sortBy=publishedAt&apiKey=dd3e0ad1bf3241e48c067fddb448707c",
      headers: {
        "User-Agent": "request",
      },
    },
...
app.get("/weatherinfosearch", function (req, res) {
  ...
  var weatherarrray = [];
  request(
    "http://api.weatherapi.com/v1/current.json?key=2011281f54f3438799b90252222505&q=" +
      cityname +
      "&aqi=nonewsapi.org",
    function (error, response, body) {
      ...
      if (JSON.parse(body).error) {
        ...
        if (JSON.parse(body).current.condition.code > 0) {
          ...
          weatherarrray.push(a1);
          weatherarrray.push(a);
          weatherarrray.push(b);
          weatherarrray.push(c);
          weatherarrray.push(d);
          weatherarrray.push(e);
          weatherarrray.push(f);
          weatherarrray.push(g);
          weatherarrray.push(h);
  ...
  request(
    {
      url:
        ...
        countryname +
        "&category=business&apiKey=dd3e0ad1bf3241e48c067fddb448707c",
      headers: {
        "User-Agent": "request",
      },
    },
